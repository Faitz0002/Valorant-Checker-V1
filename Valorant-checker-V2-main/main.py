...
r1 = requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=10000&country=all&ssl=all&anonymity=all')
...
def load_combos():
    ...
    gui()
    print()
    print(Fore.LIGHTMAGENTA_EX + "Press ENTER to select combos")
...
def checker(username, password):
    ...
    print(center("Cpm: [{}]".format(cpm2 * 120)))
